...
axs[0,1].set_title(f"Optic radiation hidden output", fontsize=title_size, pad=title_pad)


# Save and show
PATH_TO_SAVE = os.path.join(
    PATH_TO_SAVE, f"boxes_retinet_d{depth}_rks{rks}_{dataset_name}_radiation"
)
